...
\begin{figure} [H]
  ...
  \begin{axis}
    [
    ytick={1,2},
    yticklabels={Success Repeated Keys, Success Distributed Password},
    ]
    \addplot+[
    boxplot prepared={
      median=7,
...
\begin{figure} [H]
  ...
  \begin{axis}
    [
    ytick={1,2},
    yticklabels={Success Simple, Success Complex},
    ]
    \addplot+[
    boxplot prepared={
      median=6.5,
...
\begin{figure} [H]
  ...
  \begin{axis}
    [
    ytick={1,2,3,4},
    yticklabels={Success Simple No Username, Success Simple Username, Success Complex No Username, Success Complex Username},
    ]
    \addplot+[
    boxplot prepared={
      median=7,
...
\begin{figure} [H]
  ...
  \begin{axis}
    [
    ytick={1,2,3},
    yticklabels={Success Small, Success Medium, Success Long},
    ]
    \addplot+[
    boxplot prepared={
      median=7,
...
\begin{center}
\textit{Does the meaning of a word have any effect on the success of a user logging in? Comparing a password with meaning versus a password without meaning} \newline \\
\end{center}
